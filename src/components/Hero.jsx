...
import { HeroGraphicCanvas } from "./canvas";
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Erick <span className='text-[#915EFF]'>Darmawan</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
             Fullstack Web Developer focused on building
             modern and responsive web applications 
             using React.js, Laravel, and PHP.
          </p>
        </div>
      </div>
